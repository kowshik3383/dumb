...
function FeatureSection() {
  return (
    <>
      <div id="features" className="justify-center ax-w-[700px] text-center">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
        <div className="m-12 bg-gray-700 max-w-[300px] rounded-xl hover:bg-gray-900 hover:scale-110 duration-700 p-5">
          ...
          <p className="text-base leading-7 text-white font-semibold space-y-4">
            Whether you&apos;re working on a digital art piece, a music
            composition, a design project, or any other creative endeavor,
            Postcrafts provides a centralized space for sharing your projects
            with collaborators
          </p>
